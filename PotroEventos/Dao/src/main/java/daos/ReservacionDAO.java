        ...
        try {
            List<Document> reservaciones = coleccionReservaciones
                    ...
                    .aggregate(Arrays.asList(
                            ...
                            Aggregates.lookup("asientos_eventos", "boleto.asiento", "_id", "asiento_temp"),
...
//                    .first();
            ...
            return ReservacionPersistenciaAdapter.convertirADominio(reservacion);
        } catch (Exception e) {
            System.err.println("Error en DAO al buscar reservación por ID: " + e.getMessage());
            return null;
        }
    }
